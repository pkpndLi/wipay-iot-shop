...
//                Log.i("log_tag","saveTransaction :  " + )
        ...
        if(responseCode == "3030"){
            ...
            if(batchCount!! < batchUploadList.size){
                ...
                val itn = Intent(this,SettlementTLEActivity::class.java).apply{
...
//                            batchUploadPacket = batchUpload(setPccCode).toString()
                            e(log,"responseCode :: "+responseCode)
                            batchUploadOri = batchUploadWithMac(setPccCode).toString()
                            batchUploadPacket = batchUploadTlePacket(batchUploadOri,setPccCode).toString()
    ...
    fun isoUnpackResponse(isoMsg: String){
        ...
        responseCode = dataConverter.hexStringToAscii(responseCode)
        Log.i(log,"MTI:" + MTI)
